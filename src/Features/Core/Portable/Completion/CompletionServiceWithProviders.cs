...
namespace Microsoft.CodeAnalysis.Completion
{
    ...
    public abstract partial class CompletionServiceWithProviders : CompletionService
    {
        ...
        private class DisplayNameToItemsMap : IEnumerable<CompletionItem>, IDisposable
        {
            ...
            private static readonly ObjectPool<Dictionary<string, object>> s_uniqueSourcesPool = new(factory: () => new(), size: 2);
            private static readonly ObjectPool<List<CompletionItem>> s_sortListPool = new(factory: () => new(), size: 2);
